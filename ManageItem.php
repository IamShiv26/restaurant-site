...
$response = Unirest\Request::get("https://edamam-food-and-grocery-database.p.rapidapi.com/parser?ingr=apple",
  array(
    "X-RapidAPI-Host" => "edamam-food-and-grocery-database.p.rapidapi.com",
    "X-RapidAPI-Key" => "ce1c5a4d17msh87aab1c5ba5a26ep1a7bd7jsn3960aca763eb"
  )
);
console_log($response->body->hints[2]);
?>
<!DOCTYPE html>
<html>
    <head>
...
<div class="container-fluid" id="Add">
            <header style="text-align: center">
                    <h3 style="padding-top:20px">Search Grocery</h1>
            </header>
            <form action="" id="SearchForm">
    <div class="form-group">
      <label for="name">Search</label>
      <input type="text" class="form-control" id="search" placeholder="Search for Grocery" name="search" required>
    </div>
    <div id="SearchRes">
                    </div>
